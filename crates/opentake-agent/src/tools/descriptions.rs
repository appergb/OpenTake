    ...
    let mut schema = match tool {
        ...
        ToolName::PublishMotionDocument => object(
            json!({
                ...
                "transparent": {"type": "boolean", "description": "For a new clip, publish a transparent ProRes 4444 .mov with alpha instead of opaque MP4. Omit for edits; existing alpha is preserved."},
