...
pub struct ChatSession {
    ...
    pub created_at: i64,
    /// The BYOK provider this session is bound to ("openai" | "anthropic").
    /// Set on first send so a later key change doesn't mid-conversation.
    #[serde(skip_serializing_if = "Option::is_none")]
