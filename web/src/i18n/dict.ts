...
const zh: Dict = {
  ...
  "media.folder.browse": "浏览文件夹",
  "media.folder.import": "导入此文件夹",
  "media.folder.empty": "空文件夹",
  "media.folder.notAvailable": "文件夹浏览需要桌面端运行。",
  "media.generate": "生成",
  ...
  "media.offline": "媒体离线",
  "media.relink": "重新链接",
  "media.captions.empty": "暂无字幕",
  "media.captions.add": "添加字幕",
  ...
  "inspector.ai.comingSoon": "AI 功能即将上线",
  ...
  "preview.unsupportedCodec": "编解码器不受支持，无法预览此文件",
...
const en: Dict = {
  ...
  "media.folder.browse": "Browse Folders",
  "media.folder.import": "Import This Folder",
  "media.folder.empty": "Empty Folder",
  "media.folder.notAvailable": "Folder browsing requires the desktop app.",
  ...
  "media.relink": "Relink",
  "media.captions.empty": "No captions yet",
  "media.captions.add": "Add captions",
  ...
  "inspector.ai.comingSoon": "AI features coming soon",
  ...
  "preview.unsupportedCodec": "Unsupported codec — can't preview this file",
