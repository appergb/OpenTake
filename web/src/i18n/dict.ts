...
const zh: Dict = {
  ...
  "media.generate": "生成",
  "media.generateSoon": "AI 生成功能即将推出",
  "media.search": "搜索",
  "media.viewMode": "视图模式",
  "media.sort": "排序",
  "media.filter": "筛选",
  ...
  "media.folder.newFolder": "新建文件夹",
  "media.folder.untitled": "未命名文件夹",
  "media.folder.empty": "此文件夹为空",
  "media.folder.breadcrumbRoot": "媒体库",
  "media.folder.itemCount": "{count} 项",
...
const en: Dict = {
  ...
  "media.generateSoon": "AI generation is coming soon",
  "media.search": "Search",
  ...
  "media.folder.newFolder": "New Folder",
  "media.folder.untitled": "Untitled Folder",
  "media.folder.empty": "This folder is empty",
  "media.folder.breadcrumbRoot": "Media Library",
  "media.folder.itemCount": "{count} items",
