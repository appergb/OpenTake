...
Parent contract: [Editing Automation DOS](../EDITING-AUTOMATION-DOS.md). Source baseline: [Editing engine plan](../../EDITING-ENGINE-PLAN.md), [CapCut gap report](../../CAPCUT-GAP.md), [render spec](../../specs/render-SPEC.md), [frontend UI spec](../../specs/frontend-UI-1to1-SPEC.md), [known bugs](../../BUGS.md). [PORT-1TO1-GAP.md](../../PORT-1TO1-GAP.md) is historical reference only.
