...
Parent contract: [Editing Automation DOS](../EDITING-AUTOMATION-DOS.md). Source baseline: [Agent context signal](../../AGENT-CONTEXT-SIGNAL.md), [Workflow plugin system](../../WORKFLOW-PLUGIN-SYSTEM.md), [agent spec](../../specs/agent-SPEC.md), [core spec](../../specs/core-SPEC.md), [known bugs](../../BUGS.md). [PORT-1TO1-GAP.md](../../PORT-1TO1-GAP.md) is historical reference only.
