...
Parent contract: [Editing Automation DOS](../EDITING-AUTOMATION-DOS.md). Source baseline: [Agent context signal](../../AGENT-CONTEXT-SIGNAL.md), [CapCut gap report](../../CAPCUT-GAP.md), [media spec](../../specs/media-SPEC.md), [agent spec](../../specs/agent-SPEC.md), [known bugs](../../BUGS.md). [PORT-1TO1-GAP.md](../../PORT-1TO1-GAP.md) is historical reference only.
