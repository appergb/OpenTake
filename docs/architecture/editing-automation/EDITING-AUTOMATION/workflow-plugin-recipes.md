...
Parent contract: [Editing Automation DOS](../EDITING-AUTOMATION-DOS.md). Source baseline: [Workflow plugin system](../../../modules/opentake-agent/WORKFLOW-PLUGIN-SYSTEM.md), [Agent context signal](../../../modules/opentake-agent/AGENT-CONTEXT-SIGNAL.md), [agent spec](../../../modules/opentake-agent/SPEC.md), [module port map](../../MODULE-PORT-MAP.md). [PORT-1TO1-GAP.md](../../PORT-1TO1-GAP.md) is historical reference only.
