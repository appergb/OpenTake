...
- 旧的并行 Web 门禁曾受 Node 26 共享 localStorage 影响；当前统一使用显式 localStorage 文件和单 worker，最新串行门禁已 150/150 files、1405/1405 tests 通过。
...
- Web：路由 16/16，Preview/engine 44/44，串行全量 150 files / 1405 tests，`pnpm build` 均通过。
