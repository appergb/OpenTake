...
- 最终 `.app`：`web/node_modules/.bin/tauri build --bundles app` exit 0；当前安装包 SHA-256 `7634979ed3f29b2623c6dc630b34267b79e81b9129f2b4c3c48cc8dafa607f00`，构建产物 hash 一致；本轮 Computer Use 屏幕 smoke 因 Mac 锁定 blocked，媒体 Preview tabs/小屏等桌面证据仍引用之前的已完成专项包，透明 Motion 开关/发布也未升级为桌面通过。
